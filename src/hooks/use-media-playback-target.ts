...
import type { MediaPlaybackCandidate, MediaPlaybackTarget, MediaPlaybackTargetInput } from '@/types'
import { getMediaPlaybackTarget, releaseMediaPlaybackSession } from '@/platform/api'

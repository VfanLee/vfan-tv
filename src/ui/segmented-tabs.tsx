      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={cn(
              'focus-visible:ring-primary/40 inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-lg px-4 text-sm font-medium transition-[color,background-color,box-shadow] outline-none focus-visible:ring-2',
              active
